...
| `en_name`         | lastName (when available) | `feishu_en_name`       | English name; used as lastName when present; falls back to `name` when absent, which may cause cosmetic name duplication in Keycloak UIs |
